  ...
  try:
    ...
    if file_name_lower.endswith(".csv"):
      ...
      try:
        ...
        st.sidebar.error("⚠️ Excel engine (openpyxl) missing on cloud. Try CSV for now.")
        st.stop()
    ...
    # Reset file pointer back to the start before second read
    file_broker.seek(0)
    ...
    st.sidebar.success(f"✅ Processed {len(traded_images_b64)} charts!")
...
quant_ui(
    ...
    png_universe=top_70_png_universe,
    key="quant_dashboard",
)